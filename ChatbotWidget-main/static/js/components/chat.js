...
function setUserResponse(message) {
    const user_response = `<img class="userAvatar" src='http://localhost:5000/files/static/img/userAvatar.jpg'><p class="userMsg">${message} </p><div class="clearfix"></div>`;
...
function getBotResponse(text) {
    botResponse = `<img class="botAvatar" src="http://localhost:5000/files/static/img/sara_avatar.png"/><span class="botMsg">${text}</span><div class="clearfix"></div>`;
    return botResponse;
}
...
function setBotResponse(response) {
    ...
    setTimeout(() => {
        ...
        if (response.length < 1) {
            ...
            const BotResponse = `<img class="botAvatar" src="http://localhost:5000/files/static/img/sara_avatar.png"/><p class="botMsg">${fallbackMsg}</p><div class="clearfix"></div>`;
                ...
                if (Object.hasOwnProperty.call(response[i], "text")) {
                    if (response[i].text != null) {
                        ...
                        if (html.includes("<ul") || html.includes("<ol") || html.includes("<li") || html.includes('<h3')) {
                            ...
                            if (!botResponse) {
                                botResponse = `<img class="botAvatar" src="http://localhost:5000/files/static/img/sara_avatar.png"/><p class="botMsg">${response[i].text}</p><div class="clearfix"></div>`;
                            }
                        }
                ...
                if (Object.hasOwnProperty.call(response[i], "attachment")) {
                    if (response[i].attachment != null) {
                        if (response[i].attachment.type === "soundcloud") {
                            ...
                            const BotResponse = 
                            `<iframe width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1104709930&color=%23ff5500&auto_play=true&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe><div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"><a href="https://soundcloud.com/user-538536148" title="Rwanda Women&#x27;s Network" target="_blank" style="color: #cccccc; text-decoration: none;">Rwanda Women&#x27;s Network</a> · <a href="https://soundcloud.com/user-538536148/reka-tuganire-lets-talk-ep1" title="Reka Tuganire Let&#x27;s Talk Ep.1" target="_blank" style="color: #cccccc; text-decoration: none;">Reka Tuganire Let&#x27;s Talk Ep.1</a></div>`;
                            // `<div class="audio-container"> <audio controls><source src="${video_url}" type="audio/mpeg">
                            
                            //</audio> </div>`
                            // `<iframe width="100%" height="166" scrolling="no" frameborder="no"
                            // src="https://w.soundcloud.com/player/?url=${video_url};"> </iframe>`;
                            $(BotResponse).appendTo(".chats").hide().fadeIn(1000);
                        }
                    }
                }
...
function send(message) {
    $.ajax({
        ...
        data : JSON.stringify({"message" : message, "sender": sender_id, "metadata" : {"buyer_email" : "Na", "buyer_street":"Sangadigunta", "buyer_city" : "Guntur", "mern_uuid":"0000"}}),
 //"buyer_name":"Sandeep Dora", 
